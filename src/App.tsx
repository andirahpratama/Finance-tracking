  ...
  if (authLoading || financeLoading) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-slate-400">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-500 flex items-center justify-center animate-bounce shadow-xl shadow-emerald-950">
          <Wallet className="w-6 h-6 text-slate-950" />
        </div>
        <p className="mt-4 text-sm font-semibold text-white animate-pulse">Memuat Finance Tracking...</p>
        <span className="text-xs text-slate-500 mt-1">Menyiapkan database & maskot</span>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-emerald-500 selection:text-white">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 rounded-2xl bg-slate-900/80 border border-slate-800/80 p-5 backdrop-blur-xl shadow-xl flex flex-col justify-between">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white">Arus Kas (Pemasukan vs Pengeluaran)</h3>
                  <span className="text-xs text-slate-400">Grafik tren transaksi real-time</span>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-2xl bg-slate-900/80 border border-slate-800/80 p-5 backdrop-blur-xl shadow-xl">
            <CategoryPieChart transactions={transactions} />
          </div>
        </div>

        {/* 4. Transactions List & Filter Section */}
        <div className="rounded-2xl bg-slate-900/80 border border-slate-800/80 p-5 backdrop-blur-xl shadow-xl space-y-5">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-750 border border-slate-700 text-xs font-semibold text-slate-200 transition-colors"
            >
