        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              {/* Type Switcher */}
              <div className="grid grid-cols-2 gap-2 p-1.5 rounded-xl bg-slate-100 dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800">
                <button
                  type="button"
              ...
              <div className="space-y-1.5">
                ...
                {availableCategories.length === 0 ? (
                  <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-dashed border-slate-200 dark:border-slate-800 text-center text-slate-500 dark:text-slate-400 text-xs">
              ...
              <div className="pt-2 flex items-center gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-3 px-4 rounded-xl text-white font-semibold text-sm shadow-lg transition-all ${
                    type === 'expense'
                      ? 'bg-rose-600 hover:bg-rose-500 shadow-rose-950/20 dark:shadow-rose-950'
                      : 'bg-emerald-600 hover:bg-emerald-500 shadow-emerald-950/20 dark:shadow-emerald-950'
                  } disabled:opacity-50`}
                >
